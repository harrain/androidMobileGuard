...
import com.phonesafe.activity.EnterPwdActivity;
...
public class WatchDogService extends Service {
    ...
    private class WatchDogReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals("com.phonesafe.stopprotect")){
                //获取到停止保护的对象
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(Uri.parse("content://com.phonesafe.lockDataChanged"),true,new AppLockContentObserver(new Handler()));
        ...
        //停止保护
        filter.addAction("com.phonesafe.stopprotect");
