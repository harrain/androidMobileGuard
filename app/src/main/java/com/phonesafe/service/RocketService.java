...
import com.phonesafe.activity.BackgroundActivity;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        Log.e("params.x:y",params.x+":"+params.y);
                        Log.w("minheight",winHeight - 400+"");
                        if (params.x > 100 && params.x < 400
                                && params.y > winHeight - 400) {
                            Log.e("rocket","发射火箭!!!");
                            sendRocket();
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case 1:
                    ...
                    intent.setAction("com.mobile.kill");
